...
@interface CompositedViewController : UIViewController <UITextFieldDelegate, VCConnectorIConnect, VCConnectorIRegisterLogEventListener, VCConnectorIRegisterLocalCameraEventListener>
